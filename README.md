...
This is an "umbrella"-example that demonstrates most of the Ergo Framework features. It was generated with `ergo` tool with just a single command. See `README.md` file in [demo](demo) for the details.
